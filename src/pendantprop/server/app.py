...
def update_settings():
    ...
    current_settings["pendant_drop_settings"]["equilibration_sensistivity"] = float(request.form.get("equilibration_sensitivity"))
    ...
    current_settings["pendant_drop_settings"]["flow_rate_aspiration"] = float(request.form.get("flow_rate_aspiration"))
